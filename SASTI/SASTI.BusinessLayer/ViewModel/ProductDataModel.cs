...
namespace SASTI.BusinessLayer.ViewModel
{
    public class ProductDataModel
    {
        public ProductDataModel()
        {
            Categories = new List<CatModel>();
        }
        public List<CatModel> Categories { get; set; }
    }
    ...
    {
        public UserFavouriteProductResponse()
        {
            Products = new List<ProductModel>();
        }
        public List<ProductModel> Products { get; set; }
    ...
    public class CatModel
    {
        ...
        public List<SubCatModel> subCatList { get; set; }
    }
